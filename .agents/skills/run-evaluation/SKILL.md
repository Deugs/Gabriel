...
4. Every comparison must include ≥10 seeds with 95% confidence intervals, and every head-to-head claim (proposed vs. baseline) needs the paired-t-test + Cohen's d significance check, per `docs/rules.md`'s Statistical Significance quality gate.
