...
Responsibilities:
- Run training jobs via `training/train_hybrid.py` / `training/train_baselines.py` against `config/default.yaml`, `config/small_network.yaml`, or `config/large_network.yaml`, across the fixed seed list `[42, 123, 456, 789, 1011]`.
