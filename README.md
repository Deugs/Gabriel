...
| 2026-07-22 | Fix power model to EARTH standards | Al-Zubaedi validation required | Done — `config/default.yaml`/`cran_env/power_model.py` (see "Completed" note above) |
