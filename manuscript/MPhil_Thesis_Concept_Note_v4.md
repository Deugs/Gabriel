...
- λ3 (`gamma_fronthaul`, default 0.1) is chosen to be a comparatively small, non-dominant weight on fronthaul power in kW — it exists so fronthaul's contribution can be cleanly ablated (Section 4.5 of `docs/thesis_guide.md`), not to compete with the QoS/switching terms for the policy's primary objective.
